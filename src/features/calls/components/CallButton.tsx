...
export function CallButton({ phone, hasSettings }: Props) {
  ...
  function handleClick() {
    // P1 stub — módulo de ligações em desenvolvimento
    // TODO(P2): inicializar Twilio Voice SDK e abrir PhoneCallModal
    alert('Módulo de Ligações em desenvolvimento. Em breve disponível!')
  }
